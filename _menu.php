      ...
      <nav class="container navbar navbar-expand-lg navbar-light py-3 py-lg-0 px-5">
        ...
        <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
          <div class="navbar-nav font-weight-bold mx-auto py-0">
            <a href="index.php" class="nav-item nav-link item-menu-destaque">Home</a>
            <a href="#sobre" class="nav-item nav-link">Sobre</a>
            <a href="#como-funciona" class="nav-item nav-link">Como Funciona</a>
            ...
            <a href="#" class="nav-item nav-link item-menu-destaque">Apoiadores</a>
